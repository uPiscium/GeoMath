...
namespace GeoMath
{
    ...
    template <typename T, size_t Comp>
    VectorBase<T, Comp> operator+(const VectorBase<T, Comp> &v1, const VectorBase<T, Comp> &v2)
    {
    ...
    public:
        vec2() : VectorBase<T, 2>() { ; }
        vec2(const vec2 &data) : VectorBase<T, 2>((const T *)data.mArray) { ; }
        vec2(const std::vector<T> &data) : VectorBase<T, 2>(data) { ; }
        vec2(const T &c1, const T &c2) : VectorBase<T, 2>({c1, c2}) { ; }
        vec2(const vec3<T> &data) : VectorBase<T, 2>((const T *)data, this->GetSize()) { ; }
        vec2(const vec4<T> &data) : VectorBase<T, 2>((const T *)data, this->GetSize()) { ; }
    };
    ...
    public:
        vec3() : VectorBase<T, 3>() { ; }
        vec3(const vec3 &data) : VectorBase<T, 3>((const T *)data.mArray) { ; }
        vec3(const std::vector<T> &data) : VectorBase<T, 3>(data) { ; }
        vec3(const T &c1, const T &c2, const T &c3) : VectorBase<T, 3>({c1, c2, c3}) { ; }
        vec3(const vec2<T> &data) : VectorBase<T, 3>((const T *)data, data.GetSize()) { ; }
        vec3(const vec4<T> &data) : VectorBase<T, 3>((const T *)data, data.GetSize()) { ; }
    };
    ...
    public:
        vec4() : VectorBase<T, 4>() { ; }
        vec4(const vec4 &data) : VectorBase<T, 4>((const T *)data.mArray) { ; }
        vec4(const std::vector<T> &data) : VectorBase<T, 4>(data) { ; }
        vec4(const std::initializer_list<T> &data) : VectorBase<T, 4>(data) { ; }
        vec4(const T &c1, const T &c2, const T &c3, const T &c4) : VectorBase<T, 4>({c1, c2, c3, c4}) { ; }
        vec4(const vec2<T> &data) : VectorBase<T, 4>((const T *)data, data.GetSize()) { ; }
        vec4(const vec3<T> &data) : VectorBase<T, 4>((const T *)data, data.GetSize()) { ; }
    };

    template <typename T>
    vec3<T> cross(const vec2<T> &v1, const vec2<T> &v2)
    {
        vec3<T> result;
